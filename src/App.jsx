...
// --- DÜZELTİLMİŞ ONBOARDING MODAL (OTOMATİK DOLDURMA & DÜZELTME) ---
function OnboardingModal({ onComplete, initialData }) {
  // State'i düzleştirilmiş (flat) olarak başlatıyoruz ve varsa eski verileri çekiyoruz
  const [data, setData] = useState({
    ...
    bio: initialData?.bio || "",
    // İç içe veriyi (socials) düz hale getiriyoruz (Flatten)
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      // Düz veriyi onComplete'e yolla, orada paketlenecek
